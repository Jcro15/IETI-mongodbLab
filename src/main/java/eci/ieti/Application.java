...
public class Application implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        todoRepository.save(new Todo(1L,"description1",1, new Date(),"responsible1", "status"));
        todoRepository.save(new Todo(2L,"description2",2, new Date(),"responsible1", "status"));
        todoRepository.save(new Todo(3L,"description3",3, new Date(),"responsible1", "status"));
        todoRepository.save(new Todo(4L,"description4",4, new Date(),"responsible2", "status"));
        todoRepository.save(new Todo(5L,"description",5, new Date(),"responsible2", "status"));
